...
const CACHE = 'pbn-v15';
const FILES = ['./', './index.html', './manifest.webmanifest', './icon-192.png', './icon-512.png', './example.jpg', './example-after.jpg', './step-2.jpg', './step-3.jpg', './feat-levels.jpg', './feat-paint.jpg', './feat-print.jpg', './robots.txt', './sitemap.xml'];

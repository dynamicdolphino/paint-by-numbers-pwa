...
const CACHE = 'pbn-v14';
const FILES = ['./', './index.html', './manifest.webmanifest', './icon-192.png', './icon-512.png', './example.jpg', './example-after.jpg', './feat-levels.jpg', './feat-paint.jpg', './feat-print.jpg', './robots.txt', './sitemap.xml'];
